...
export default function MonsterCursor() {
  ...
  useEffect(() => {
    ...
    document.addEventListener("mousedown", function(event) {
      ...
      else if (event.button === 1) Input.mouse.middle = true
      else if (event.button === 2) Input.mouse.right = true
    })

    document.addEventListener("mouseup", function(event) {
      if (event.button === 0) Input.mouse.left = false
      else if (event.button === 1) Input.mouse.middle = false
      else if (event.button === 2) Input.mouse.right = false
    })
    ...
    // Initialize
    ctx.strokeStyle = "rgba(0, 245, 208, 0.3)"
    ctx.lineWidth = 1
